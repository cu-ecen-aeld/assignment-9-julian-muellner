...
INITSCRIPT_NAME:${PN} = "mm-start-stop.sh"
...
inherit module
FILES:${PN} += "${sysconfdir}/init.d/mm-start-stop.sh"

do_install () {
    install -d ${D}${sysconfdir}/init.d
    install -m 0755 "${WORKDIR}/files/mm-start-stop.sh" ${D}${sysconfdir}/init.d/
